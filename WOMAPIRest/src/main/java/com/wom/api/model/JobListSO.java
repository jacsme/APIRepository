...
@Entity
@Table(name = "WOMDBPR.tbljoblistSO")
public class JobListSO implements Serializable {

	public JobListSO(){}
	public JobListSO(String jobid, String productcode, String suppliercode, String departmentcode, String jobtype, String staffcode){
		this.jobId = jobid;
